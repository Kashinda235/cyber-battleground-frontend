...
const HoneyPotControlPanel = ({ onBack }) => {
    ...
    return (
        <div className="w-full h-full mx-auto bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-xl overflow-hidden flex flex-col">
