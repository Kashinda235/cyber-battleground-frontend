...
import {
  MessageSquare, Zap, Bell, AlertTriangle, Info, ShieldCogCorner, Calendars, Tickets, User,
} from "lucide-react"
...
const NavButton = ({activeTab, targetTab, onClick, icon: Icon, title, activeColorClass, hasBadge = false,
                          }: NavButtonProps) => {
...
export default function ActivityFeed() {
  const { players, activeTab, setActiveTab } = useGame();
